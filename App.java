...
public class ImageIFMG extends JFrame {
    ...
    public ImageIFMG() {
        ...
        JMenuItem item10 = new JMenuItem("Detectar celular");
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        for (int i = 0; i < mat.length; i++) {
                            for (int j = 0; j < mat[0].length; j++) {
                                if (mat[mat.length / 2][j] == 0 && startHorizontal == 0) {
                                    startHorizontal = j;
                                }
                                if (mat[mat.length / 2][j] == 255 && startHorizontal != 0 && endHorizontal == 0) {
                                    endHorizontal = j;
                                }
                            }
                        }
                        ...
                        for (int i = 0; i < mat.length; i++) {
                            for (int j = 0; j < mat[0].length; j++) {
                                if (mat[i][mat[0].length / 2] == 0 && startVert == 0) {
                                    startVert = i;
                                }
                                if (mat[i][mat[0].length / 2] == 255 && startVert != 0 && endVert == 0) {
                                    endVert = i;
                                }
                            }
                        }

                        System.out.println("dimensions: " + mat.length + " " + mat[0].length);
                        System.out.println("vertical: " + startVert + " - " + endVert);
                        System.out.println("horizontal: " + startHorizontal + " - " + endHorizontal);

                        int[][] matRed = matR;

                        for (int i = 0; i < mat.length; i++) {
                            for (int j = 0; j < mat[0].length; j++) {
                                if (i == startVert - 20 && j >= startHorizontal - 20 && j <= endHorizontal + 20) {
                                    matRed[i][j] = 255;
                                    mat[i][j] = 0;
                                    mat[i][j] = 0;
                                }
                        ...
                        for (int i = 0; i < mat.length; i++) {
                            for (int j = 0; j < mat[0].length; j++) {
                                if (i == endVert + 20 && j >= startHorizontal - 20 && j <= endHorizontal + 20) {
                                    matRed[i][j] = 255;
                                    mat[i][j] = 0;
                                    mat[i][j] = 0;
                                }
                        ...
                        for (int i = 0; i < mat.length; i++) {
                            for (int j = 0; j < mat[0].length; j++) {
                                if (j == startHorizontal - 20 && i >= startVert - 20 && i <= endVert + 20) {
                                    matRed[i][j] = 255;
                                    mat[i][j] = 0;
                                    mat[i][j] = 0;
                                }
                        ...
                        for (int i = 0; i < mat.length; i++) {
                            for (int j = 0; j < mat[0].length; j++) {
                                if (j == endHorizontal + 20 && i >= startVert - 20 && i <= endVert + 20) {
                                    matRed[i][j] = 255;
                                    mat[i][j] = 0;
                                    mat[i][j] = 0;
                                }
